...
async function optimizeChunk(text, prevContext = null) {
    ...
    const response = await deepseek.chat.completions.create({
        ...
        messages: [
            {
                role: 'system',
                content: '你是专业的音频转录文本优化助手。修正错别字、同音字错误，改善语法，添加合适标点，但必须保持原意不变。按话题合理分段，Markdown格式，段落间双换行，不加分隔线。【必须使用简体中文输出，严禁繁体中文。写"投资"不写"投資"，写"经济"不写"經濟"。】'
            },
            {
                role: 'user',
...
【输出语言要求】必须使用简体中文输出，严禁使用繁体中文。例如写"投资"而不是"投資"，写"周期"而不是"週期"，写"经济"而不是"經濟"。
...
【严格排除】赞助商广告、节目资助方信息、播客开头结尾语、制作团队信息。

格式：Markdown，段落之间用双换行分隔，每个段落专注一个主题。`
            },
...
【输出语言要求】必须使用简体中文，严禁繁体中文。例如写"投资"不写"投資"。
1. 去除重复内容
2. 按主题重新组织
3. 段落之间必须有空行分隔
4. Markdown格式，简体中文输出
